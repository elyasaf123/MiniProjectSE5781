...
public class ReflectionRefractionTests {
    ...
    public void trianglesTransparentSphere() {
        ...
        render.setImageWriter(imageWriter).setCamera(camera).setRayTracer(new BasicRayTracer(scene));
    ...
    public void ex_7_our_picture() {
        ...
        render.setImageWriter(imageWriter).setCamera(camera).setRayTracer(new BasicRayTracer(scene)).setMultithreading(3).setDebugPrint().setSuperS(false);
...
//                        .setMaterial(new Material().setKd(1).setKs(0).setNShininess(50))).getCube(1),
    ...
    public void ex_10_our_picture() {
        ...
        geometries.add(
                ...
                /////////           FLOOR - MIRROR                 ///////////
//                new Polygon(
//                        new Point3D(60,-30, -13),
//                        new Point3D(-60,-30,-13),
//                        new Point3D(-60,90,-13),
//                        new Point3D(60, 90,-13)).
...
//        ,
        ...
        for(int i = 0; i < 20; i++) {
            ...
            geometries.add(
                    new Sphere(new Point3D(randomDouble(-69, 69), randomDouble(-39, 99), randomRadius -14), randomRadius)
