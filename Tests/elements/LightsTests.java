...
public class LightsTests {
    ...
    private Camera.CameraBuilder cameraBuilder1 = new Camera.CameraBuilder(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
            .setViewPlaneSize(150, 150) //
            .setDistance(1000);
    private Camera camera1 = cameraBuilder1.build();
    private Camera.CameraBuilder cameraBuilder2 = new Camera.CameraBuilder(new Point3D(0, 0, 1000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
    ...
    public void sphereDirectional() {
        ...
        sceneBuilder1.setLights(List.of(new DirectionalLight(new Color(500, 300, 0), new Vector(1, 1, -1))));
    ...
    public void trianglesDirectional() {
        sceneBuilder2.setGeometries(new Geometries(triangle1.setMaterial(new Material().setkD(0.8).setkS(0.2).setnShininess(300)), //
                triangle2.setMaterial(new Material().setkD(0.8).setkS(0.2).setnShininess(300))));
        sceneBuilder2.setLights(List.of(new DirectionalLight(new Color(300, 150, 150), new Vector(0, 0, -1))));
    ...
    public void trianglesMultiLight() {
        Geometries geometries = new Geometries(triangle1.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(300)),triangle2.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(300)));
        sceneBuilder2.setGeometries(geometries);
        sceneBuilder2.setLights(List.of(new SpotLight(new Color(0, 250, 0), new Point3D(0, 50, -100), new Vector(0, 0, -1)),new SpotLight(new Color(0, 250, 250), new Point3D(50, 0, -145), new Vector(0, 0, -1)),new SpotLight(new Color(100, 50, 200), new Point3D(50, 50, -145), new Vector(0, 0, -1)),new PointLight(new Color(0,0,250),new Point3D(0,0,-145)),new DirectionalLight(new Color(100,0,0),new Vector( 1,1,-1))));
        Scene scene2 = sceneBuilder2.build();
    ...
    public void sphereMultiLight() {
        sceneBuilder1.setGeometries(new Geometries(sphere));
        sceneBuilder1.setLights(List.of(new SpotLight(new Color(100, 0, 0), new Point3D(0, 0, 10), new Vector(0, 0, -1)),new SpotLight(new Color(350, 350, 0), new Point3D(0, 40, 10), new Vector(0, 0, -1)),new SpotLight(new Color(350, 350, 0), new Point3D(40, 0, 10), new Vector(0, 0, -1)),new PointLight(new Color(500,0,0),new Point3D(200,200,-50)),new DirectionalLight(new Color(400,350,355),new Vector( 10,10,-10))));//
        Scene scene1 = sceneBuilder1.build();
