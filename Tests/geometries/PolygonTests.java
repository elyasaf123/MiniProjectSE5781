...
public class PolygonTests {
    ...
    public void testConstructor() {
        ...
        try {
            ...
            fail("ERROR - TC01: Failed constructing a correct polygon");
        }
        ...
        try {
            ...
            fail("ERROR - TC02: Constructed a polygon with wrong order of vertices");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("ERROR - TC03: Constructed a polygon with vertices that are not in the same plane");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("ERROR - TC04: Constructed a concave polygon");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("ERROR - TC10: Constructed a polygon with vertx on a side");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("ERROR - TC11: Constructed a polygon with vertx on a side");
        } catch (IllegalArgumentException e) {}
        ...
        try {
            ...
            fail("ERROR - TC12: Constructed a polygon with vertex on a side");
        } catch (IllegalArgumentException e) {}
    }
    ...
    public void testGetNormal() {
        ...
        assertEquals(
                ...
                "ERROR - TC01: Bad normal to polygon");
    }
