...
class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(-1, 0, 0), new Vector(1, 1, 0))), "TC01: Ray's line out of sphere");
        ...
        List<Point3D> result3 = sphere.findIntersections(new Ray(new Point3D(1.5, 0, 0),
                new Vector(-0.5, 0, 1)));
        assertEquals(1, result3.size(), "TC03: Wrong number of points");
            result3 = List.of(result3.get(0));
        assertEquals(List.of(p3), result3, "TC03: Ray is exiting sphere");


        // TC04: Ray starts after the sphere (0 points)
        assertNull(sphere.findIntersections(new Ray(new Point3D(1, 0, 2), new Vector(1, 1, 1))),
                "TC04: Ray is off the sphere");
        ...
        List<Point3D> result5 = sphere.findIntersections(new Ray(new Point3D(0, 0, 0),
                new Vector(1, 0, 1)));
        assertEquals(1, result5.size(), "TC05: Wrong number of points");
        assertEquals(List.of(p5), result5, "TC05: Ray is start on the sphere and exiting via the sphere");
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(1, 0, 1), new Vector(1, 1, 1))),
                "TC06: Ray is start on the sphere and exiting off the sphere");
        ...
        List<Point3D> result7 = sphere.findIntersections(new Ray(new Point3D(-1, 0, 0),
                new Vector(1, 0, 0)));
        assertEquals(2, result7.size(), "TC07: Wrong number of points");
        if (result7.get(0).getXDouble() > result.get(1).getXDouble()) {
            result7 = List.of(result7.get(1), result7.get(0));
        }
        assertEquals(List.of(p7a, p7b), result7, "TC07: Ray crosses sphere's center");
        ...
        List<Point3D> result8 = sphere.findIntersections(new Ray(new Point3D(0, 0, 0),
                new Vector(1, 0, 0)));
        assertEquals(1, result8.size(), "TC08: Wrong number of points");
        assertEquals(List.of(p8), result8, "TC08: Ray is start on the sphere and crosses sphere's center");
        ...
        List<Point3D> result9 = sphere.findIntersections(new Ray(new Point3D(0.5, 0, 0),
                new Vector(1, 0, 0)));
        assertEquals(1, result9.size(), "TC09: Wrong number of points");
        assertEquals(List.of(p9), result9, "TC09: Ray is start on the sphere and crosses sphere's center");
        ...
        List<Point3D> result10 = sphere.findIntersections(new Ray(new Point3D(1, 0, 0),
                new Vector(1, 0, 0)));
        assertEquals(1, result10.size(), "TC10: Wrong number of points");
        assertEquals(List.of(p10), result10, "TC10: Ray is start on the sphere's center");
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(1, 0, 1), new Vector(0, 0, 1))),
                "TC11: Ray is start on the sphere and exiting off the sphere");

        // TC12: Ray starts after sphere (0 points)
        assertNull(sphere.findIntersections(new Ray(new Point3D(1, 0, 1.5), new Vector(0, 0, 1))),
                "TC12: Ray is start out of the sphere and exiting off the sphere");
