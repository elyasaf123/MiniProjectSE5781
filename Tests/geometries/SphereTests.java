...
class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(2, result2.size(), "ERROR - TC02: Wrong number of points");
        if (result2.get(0).getXDouble() > result2.get(1).getXDouble()) {
        ...
        if (result7.get(0).getXDouble() > result2.get(1).getXDouble()) {
